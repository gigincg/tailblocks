    ...
    return (
      ...
      >
        ...
        <div className="toolbar">
          ...
          {/* Toggle ShowBuilder Bytton */}
          <button className="copy-the-block" onClick={this.toggleShowBuilder}>
            <span>
              {!this.state.showBuilder ? "OPEN BUILDER" : "GO TO LIBRARY"}
            </span>
          </button>
          ...
          <div className={`view${this.state.codeView ? " show-code" : ""}`}>
            ...
            >
              {!this.state.showBuilder ? (
                ...
                <Builder
                  removeBlockCB={this.removeBlock}
                  theme={theme}
                  darkMode={darkMode}
                  buildState={this.state.builder}
                />
              )}
            </Frame>
            <div className="codes">
